        ...
        <div className="flex justify-between items-center h-20">
          ...
          <div className="flex items-center space-x-6">
            <div className="hidden md:flex items-center space-x-1">
              <a href="/" className="relative px-4 py-2 text-white hover:text-blue-100 transition-colors duration-200 rounded-lg hover:bg-white/10 group">
                Home
              ...
              <a href="/services" className="relative px-4 py-2 text-white hover:text-blue-100 transition-colors duration-200 rounded-lg hover:bg-white/10 group">
                Services
                <span className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-white transition-all duration-200 group-hover:w-full group-hover:left-0"></span>
              </a>
              <a href="/about" className="relative px-4 py-2 text-white hover:text-blue-100 transition-colors duration-200 rounded-lg hover:bg-white/10 group">
                About
                <span className="absolute bottom-0 left-1/2 w-0 h-0.5 bg-white transition-all duration-200 group-hover:w-full group-hover:left-0"></span>
              </a>
              <a href="/booking" className="ml-4 px-6 py-2 bg-white text-blue-700 font-semibold rounded-full hover:bg-blue-50 hover:shadow-lg transform hover:-translate-y-0.5 transition-all duration-200 border-2 border-transparent hover:border-white/20">
                Book Now
              </a>
            </div>
